...
**Answer:** a. Treatment variable is female which indicates if a female is head politician of the village, variable is under the name female
b. Outcome variable is drinking water facilities, variable is under tha name water
...
**Answer:** a. the treatment variable is still female, which represents the villages that are ran by female politicians
b. the outcome variable this time is irrigation, which represents the quantitiy of irrigation faciltiies built in villages. 
...
**Answer:** a. the treatment group is a women lead village. 
b. control group is male lead village 
